...
这个是做 **AI 对话机器人**产品时顺手做的免费小工具——只做最基础的关键词匹配，理解不了语义、也记不住上下文。完整版是真正理解语义的多轮对话、私有知识库训练、多渠道嵌入（网页/App/小程序），源码在这：[全能源码 · AI 对话机器人网站源码](https://inzyxuashop.com/aiduihua-yuanma.html)。
